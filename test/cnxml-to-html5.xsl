...
<xsl:template match="c:document">
  <xsl:variable name="count" select="count(.//c:para)"/>
  <xsl:variable name="firstName" select="'Philip'"/>
  <xsl:variable name="myXmlContext" select="."/>
  <xsl:variable name="paragraphs" select=".//c:para"/>
  <!-- Other XPath expressions like map, list, set, tuples, etc (for JSON) -->
